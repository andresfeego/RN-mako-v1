...
export default class Promo extends Component {
  ...
  constructor(props) {
    ...
    this.ImageURI = 'https://www.mako.guru/directorio/imagenes/promos/'+this.props.item.codigo+'/'+this.props.item.imagen;
...
componentDidMount(){
  ...
  facebookShare(idPromo) {
    let mensa = 'https://mako.guru/directorio/directorio3.php?id='+this.props.item.codigo+'&idPromo='+idPromo;
...
Actions.DetalleVenta({empresa});
  ...
  render() {
        ...
        const imgPromo = 'https://www.mako.guru/directorio/imagenes/promos/'+this.props.item.codigo+'/'+this.props.item.imagen;
